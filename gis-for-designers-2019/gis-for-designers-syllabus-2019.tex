...
%
%\begin{table}[H]
%\begin{tabular}{l @{\hskip 2.1cm} l @{\hskip 1.1cm} l}
%\textbf{Cartography} & \textbf{Geospatial Analysis} & \textbf{Geospatial Modeling}\\
%\end{tabular}
%\end{table}
%%
%\vspace*{-1em}
...
%\noindent
%\includegraphics[width=\textwidth]{images/new-orleans-landscape-1.png}
...
\noindent
%\includegraphics[width=\textwidth]{images/new-orleans-landscape-1.png}
%\includegraphics[width=\textwidth]{images/new-orleans-3d-print.jpg}
