...
and use algorithms to generate, analyze, and construct designs.
Experiment with emerging technologies for the design and construction of the built environment.
Learn how to 
procedurally model landscape and urban form,
numerically simulate physical processes 
such as the flow of wind and water,
pilot drones and conduct aerial surveys,
digitally fabricate models,
and autonomously construct structures.
The final project will be a robotically assembled wall. 
\\
...
\begin{table}[H]
\begin{tabular}{l @{\hskip 2.1cm} l @{\hskip 2.6cm} l}
\textbf{Fundamentals} & \textbf{Modeling} & \textbf{Robotics}\\
\end{tabular}
\end{table}
...
\small
\textbf{1} & Computational design \hspace{1em}  & \textbf{6} & Drones  \hspace{6em} & \textbf{11} & Materials research\\
\textbf{2} & Stochasticity & \textbf{7} & Terrain & \textbf{12} & Procedural assemblies\\
\textbf{3} & Noise & \textbf{8} & Hydrology & \textbf{13} & Robotic operations\\
\textbf{4} & Gradients & \textbf{9} & Fabrication & \textbf{14} & Robotic programming\\
\textbf{5} & Physics & \textbf{10} & Simulation & \textbf{15} & Robotic construction\\
\end{tabular}
\end{table}
