...
\def\myemail{mdeque1@lsu.edu, hbgilbert@lsu.edu, baharmon@lsu.edu, \& hyenam@lsu.edu}
\def\myweb{https://baharmon.github.io/}
\def\myphone{919.622.8414}
\def\myversion{}
\def\myrevision{}
\def\myaffiliation{\ \\Louisiana State University}
\def\myauthor{\normalsize Marcio de Queiroz, Hunter Gilbert, Brendan Harmon, \& Hye Yeon Nam}
...
\vspace*{0.5cm}
\\[0.1cm] {\normalfont \normalsize ME 4933 \& LA 7504 \& ART 7255 |} \Large Ecological Robotics
} 
...
\maketitle
\vspace*{1cm}
%\includegraphics[width=1\textwidth]{images/robotic-garden-02.png}\\
