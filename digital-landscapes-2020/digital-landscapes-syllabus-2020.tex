...
using laser cutting and 3D printing.
You will also learn how to make graphics through
3D rendering, aerial photography, and photomontage.\\
...
Design and build a module for a toolkit of laser cut models
for participatory design workshops on complete streets.
Deliverables include a CAD drawing
and a laser cut model of your module.
\emph{Due: 02/22/2020}\\

\noindent \textbf{Streetscape}
3D model and 3D render a streetscape scene.
Your model should include a transect of the street
with 3D planting and the buildings on each side.
Deliverables include 3D renderings and a 3D print.
\emph{Due: 03/20/2020}\\
...
%\vspace*{2em}
%\noindent
%\includegraphics[width=\textwidth]{images/participatory-design-toolkit-4.jpg}
...
Participatory Design Toolkit & 30\% & Streetscape & 30\% \\
Streetscape & 30\% & Portfolio & 5\% \\
\end{tabular}
\end{table}
