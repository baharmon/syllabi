...
\def\mytitle{ \includegraphics[width=6cm]{../logos/lsu_art_design_white_logo.pdf} \\[0.1cm] {\normalfont \normalsize LA 7031 |} \Large Water Studio} 
...
%\ThisCenterWallPaper{1.36}{images/amite-imagery-1.png} 
\ThisCenterWallPaper{1}{images/amite.jpg} 
