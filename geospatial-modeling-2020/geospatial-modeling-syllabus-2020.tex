...
\textbf{Lidar \& drone analytics} & \textbf{Generative design}\\
\end{tabular}
\end{table}
%
\vspace*{-1em}
...
\small
\textbf{1} & Lidar & \textbf{6} & Parametric design\\
\textbf{2} & Terrain modeling & \textbf{7} & Parametric landforms\\
\textbf{3} & Digital fabrication & \textbf{8} & Visual programming\\
\textbf{4} & Hydrological modeling & \textbf{9} & Generative processes\\
\textbf{5} & Erosion modeling & \textbf{10} & Attractors\\
\end{tabular}
\end{table}
%
