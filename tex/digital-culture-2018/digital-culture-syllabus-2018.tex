...
\vspace*{-10em}
\maketitle
\ThisCenterWallPaper{1}{../images/parametric_bench_1.png} 
\clearpage
...
09.04.2018 & \textbf{Open science +} & \emph{Python:} flow control \\ % dictionaries \& data
09.11.2018 & \textbf{Death of the author +} & \emph{Python:} Markov chains \\ % flow control
\\
\normalsize
...
10.02.2018 & \textbf{Digital poetry +} & Poetry charrette \\ % Death of the poet % & Lara Glenum
10.09.2018 & \textbf{Sonic art +} & Poetry recordings \\ % Jesse Allison % Edgar Berdahl
\\
\normalsize
...
\includegraphics[width=\textwidth]{../images/parametric_bench_2.png}
