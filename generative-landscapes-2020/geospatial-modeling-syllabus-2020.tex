...
\textbf{Lidar \& drone analytics} & \textbf{Generative design} & \textbf{Digital fabrication}\\
\end{tabular}
\end{table}
%
\vspace*{-1em}
...
%
01.21.2020 & \textbf{Reading |} & Alphabet \& algorithmn \\
01.23.2020 & \textbf{Reading |} & Digital fabrication in arch. & \textbf{Essay:} Generative design \\
%
...
%
03.10.2020 & \textbf{Tutorial |} & Parametric patterns \\
...
04.02.2020 & \textbf{Tutorial |} & Waveforms \\
%
...
04.30.2020 & \textbf{Gallery |} & Final review\\ 
%
\end{tabular}
\end{table}
...
on generative design and digital fabrication.
How do you envision yourself using
generative design and digital fabrication
in your design process?
How have digital tools have transformed 
...
digital elevation model, and orthophoto.
...
for a series of landform variations
in a virtual flume. 
\\
